                ...
                <div className="row">
                  <div className="col-lg-5 footer_logo mb-4 mb-lg-0">
                    ...
                    <p className="footer_text" style={{ textAlign: "justify" }}>
                      At SafeTrack, we're dedicated to making Secure website
                  ...
                  <div className="col-lg-4 px-lg-5 mb-4 mb-lg-0">
                    ...
                    <p className="footer_text">
                      <a>aditya61.be22@chitkara.edu.in</a>
                      <br />
                  ...
                  <div className="col-lg-3 mb-4 mb-lg-0">
                    ...
                    <p>
                      <a
                        href="www.linkedin.com/in/aditya-bisht-3a74a0317"
                      ...
                      <a
                        href="https://github.com/JustAreapeR"
                        className="footer_social_media_icon"
                        style={{ color: "white" }}
                      >
                        <BsGithub size={25} />
            ...
            <section id="contact" className="footer_wrapper">
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-12 footer_credits text-center">
                    <span>
                      © 2023 <a>SafeTrack</a>™. All Rights Reserved.
                    </span>
                  </div>
                </div>
              </div>
